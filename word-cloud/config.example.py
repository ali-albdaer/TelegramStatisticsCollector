...
BACKGROUND_COLOR = "black"  # The background color of the word clouds
...
WORD_COUNT = 200  # The number of words to include in the word clouds
CATEGORY_WORD_COUNT = 200  # The number of top words to include in each category word cloud
